...
@REM set _JAVA_OPTIONS="-Djava.security.manager=allow"

@rem Run Robocode with Java
java -Dsun.io.useCanonCaches=false -DNOSECURITY=true -Xmx512M -cp "libs/robocode.jar;C:\swipl\bin\jpl.dll;C:\swipl\lib\jpl.jar;C:\swipl\library\jpl.pl;C:\swipl\bin\libpl.dll" -XX:+IgnoreUnrecognizedVMOptions "--add-opens=java.base/sun.net.www.protocol.jar=ALL-UNNAMED" "--add-opens=java.base/java.lang.reflect=ALL-UNNAMED" "--add-opens=java.desktop/javax.swing.text=ALL-UNNAMED" "--add-opens=java.desktop/sun.awt=ALL-UNNAMED" robocode.Robocode %*


@REM C:\swipl\bin\jpl.dll;C:\swipl\lib\jpl.jar;C:\swipl\library\jpl.pl;C:\swipl\bin\libpl.dll
